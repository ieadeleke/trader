...
class CoinGeckoAPI {
  static async getTopCryptocurrencies(limit: number = 100): Promise<CryptoData[]> {
    try {
  ...
  return (
    <Card style={cardStyle}>
      <Statistic
        ...
        suffix={suffix}
        valueStyle={{ 
          color: isPositive !== undefined ? (isPositive ? '#059669' : '#dc2626') : '#1890ff',
          fontSize: '24px',
          fontWeight: 'bold'
        }}
      />
        ...
        <Row gutter={[16, 16]} style={{ marginBottom: '32px' }}>
          <Col xs={24} sm={12} lg={6}>
            <StatCard
              ...
              value={globalData ? formatLargeNumber(globalData.data.total_market_cap.usd) : ''}
          ...
          <Col xs={24} sm={12} lg={6}>
            <StatCard
              title="BTC Dominance"
              value={globalData ? `${globalData.data.market_cap_percentage.btc.toFixed(1)}%` : ''}
