...
export default function Flow() {
  return (
    <section id="aboutus">
      <div className="grid grid-cols-2 items-cente gap-10 px-28 mt-28">
        <div>
          <Image
            src={FlowImg}
            alt="how it works"
        ...
        <div>
          <h3 className="text-3xl mb-5 font-ubuntu font-bold">Who We Are</h3>
          <p className="text-base leading-loose opacity-80 mb-5">
          ...
          <p className="text-base leading-loose opacity-80 mb-10">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto
            quaerat magnam vitae, iste facere consequatur nam enim ex rem, odit
            natus, mollitia error porro sed assumenda? Ullam consequatur numquam
            esse!
          </p>
          <button className="bg-primary text-sm py-4 px-10 rounded-[8px]">
            Reach out to us
          </button>
          {/* <div className="flow-bg pt-6 pb-10 px-8 mb-7 rounded-[10px] gap-4 flex items-start">
            <div>
              <div className="size-[36px] rounded-[10px] flow-bg flex items-center justify-center">
                <h4 className="text-base font-bold">1</h4>
              </div>
            </div>
            <div>
          ...
          <div className="flow-bg pt-6 pb-10 px-8 mb-7 rounded-[10px] gap-4 flex items-start">
            <div>
              <div className="size-[36px] rounded-[10px] flow-bg flex items-center justify-center">
                <h4 className="text-base font-bold">2</h4>
              </div>
            </div>
            <div>
              <h3 className="text-xl mb-2 font-medium font-ubuntu">
          ...
          <div className="flow-bg pt-6 pb-10 px-8 rounded-[10px] gap-4 flex items-start">
            <div>
              <div className="size-[36px] rounded-[10px] flow-bg flex items-center justify-center">
                <h4 className="text-base font-bold">3</h4>
              </div>
            </div>
            <div>
              <h3 className="text-xl mb-2 font-medium font-ubuntu">
