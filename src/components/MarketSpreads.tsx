          ...
          <SwiperSlide>
            <div className="flow-bg rounded-[12px]">
              <div className="pt-6 md:pt-10 pb-3 pl-4 md:pl-8 py-4 md:pr-8">
                ...
                <ReadMore
                  text={`At CFD Rocket, financial planning is more than just a budgeting exercise — it's a strategic roadmap for wealth creation, risk management, and long-term financial security. Our AI-powered platform combines deep data analytics with personalized financial goal-setting to help clients design actionable plans tailored to their income, lifestyle, and aspirations. Whether you're planning for retirement, education, a major purchase, or early financial freedom, CFD Rocket helps you forecast future needs and align your investment and saving strategies accordingly. Our approach covers income tracking, expense management, debt reduction, emergency fund allocation, insurance needs, and tax-efficient strategies — all customized in real time based on your evolving financial profile. What sets CFD Rocket apart is the integration of AI with human oversight, ensuring that every financial plan is not only optimized for market realities but also aligned with your personal vision of success.`}
                />
              </div>
            </div>
          </SwiperSlide>
