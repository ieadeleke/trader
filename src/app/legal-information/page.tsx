      ...
      <div>
        ...
        <section className="px-5 md:px-12 py-20 md:py-12 md:w-[60%] mx-auto">
          <h1 className="text-xl font-semibold mb-4">
            CFD Rocket Terms and Conditions
          </h1>
          ...
          <p className="text-sm leading-loose mb-3">
            Welcome to CFD Rocket. These Terms and Conditions (“Terms”) govern
            your access to and use of the CFD Rocket website, mobile application,
          ...
          <p className="text-sm leading-loose mb-3">
            CFD Rocket is an online forex and digital asset exchange platform
            that allows users to trade foreign currencies, cryptocurrencies, and
            related financial products. CFD Rocket operates globally but may
          ...
          <ul className="list-disc pl-5 text-sm leading-loose mb-3 space-y-2">
            ...
            <li>
              CFD Rocket reserves the right to suspend or terminate accounts that
          ...
          <ul className="list-disc pl-5 text-sm leading-loose mb-3 space-y-2">
            <li>
              Trading on CFD Rocket involves significant risks, including market
          ...
          <ul className="list-disc pl-5 text-sm leading-loose mb-3 space-y-2">
            <li>
              CFD Rocket charges transaction fees, withdrawal fees, and other
          ...
          <ul className="list-disc pl-5 text-sm leading-loose mb-3 space-y-2">
            ...
            <li>
              CFD Rocket does not guarantee profits or the future value of any
          ...
          <ul className="list-disc pl-5 text-sm leading-loose mb-3 space-y-2">
            <li>
              CFD Rocket is not liable for indirect, incidental, or consequential
          ...
          <ul className="list-disc pl-5 text-sm leading-loose mb-3 space-y-2">
            ...
            <li>
              CFD Rocket may report suspicious activities to regulatory
